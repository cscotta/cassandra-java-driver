...
/**
 * Metadata describing the columns returned in a {@link ResultSet} or a {@code PreparedStatement}.
 *
 * <p>A {@code ColumnDefinitions} instance is mainly a list of {@code
 * ColumnDefinitions.Definition}. The definitions or metadata for a column can be accessed either by
 * index (indexed from 0) or by name.
 *
 * <p>When accessed by name, column selection is case insensitive.
 */
