...
public class UserType extends DataType implements Iterable<UserType.Field> {
  ...
  // SHELL: replaced in tier 5 (metadata). 3.x built UserType from schema Rows via
  // Cluster/KeyspaceMetadata/DataTypeCqlNameParser; that construction is wired to 4.x later.
  // This is a package-private (non-ABI) helper; removed for the foundation tiers.
