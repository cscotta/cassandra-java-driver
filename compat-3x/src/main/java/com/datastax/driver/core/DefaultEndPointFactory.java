...
public class DefaultEndPointFactory implements EndPointFactory {
  ...
  public EndPoint create(Row peersRow) {
    if (peersRow.getColumnDefinitions().contains("native_address")) {
      ...
      return new TranslatedAddressEndPoint(new InetSocketAddress(nativeAddress, nativePort));
      ...
      return new TranslatedAddressEndPoint(new InetSocketAddress(rpcAddress, 9042));
    }
  }
}
