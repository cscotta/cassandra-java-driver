 ...
 *
 * <p>This is intended for use with a custom {@link RetryPolicy}, load balancing policy or
 * speculative execution policy. The client code can wrap a statement to "mark" it, or add
