 ...
 *
 * <p>The values of a BoundStatement can be set by either index or name.
 *
...
public class BoundStatement extends Statement
  ...
  /**
   * Unsets all occurrences of variable {@code name}.
   *
  ...
  /**
   * Sets the routing key for this bound statement, when the query partition key is composite.
   *
