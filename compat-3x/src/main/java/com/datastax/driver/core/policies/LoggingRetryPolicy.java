 ...
 *
 * <p>Note that this policy only logs {@link RetryPolicy.RetryDecision.Type#RETRY RETRY} and {@link
 * RetryPolicy.RetryDecision.Type#IGNORE IGNORE} decisions.
 */
public class LoggingRetryPolicy implements RetryPolicy {
   ...
   *
   * @param template The template to use; arguments must be specified in SLF4J style.
