...
/**
 * Convenience base class for {@link SchemaChangeListener} implementations: all methods have empty
 * default bodies so subclasses only override the events they care about.
 */
public abstract class SchemaChangeListenerBase implements SchemaChangeListener {

  public SchemaChangeListenerBase() {}
